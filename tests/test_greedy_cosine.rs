//! Tests for the GreedyCosine similarity implementation.
//!
//! Reference values are computed with matchms CosineGreedy
...
fn cosine() -> GreedyCosine<f32, f32> {
    GreedyCosine::new(1.0, 1.0, 0.1).expect("valid scorer config")
}
...
// ---------- cross-similarity (matchms CosineGreedy reference) ----------
