...
use mass_spectrometry::fuzzing::{FlashCosineHarnessOutcome, run_flash_cosine_case};

const ARTIFACTS_DIR: &str = "fuzz/artifacts/flash_cosine";
const FIXTURE_CRASH_DIR: &str = "tests/fixtures/fuzz/flash_cosine/crashes";

#[test]
fn replay_all_flash_cosine_crashes() {
    ...
    for crash_file in &crash_files {
        ...
        let outcome = run_flash_cosine_case(&bytes);
        assert_eq!(
            outcome,
