...
use mass_spectrometry::fuzzing::{HungarianCosineHarnessOutcome, run_hungarian_cosine_case};

const ARTIFACTS_DIR: &str = "fuzz/artifacts/hungarian_cosine";
const FIXTURE_CRASH_DIR: &str = "tests/fixtures/fuzz/hungarian_cosine/crashes";

#[test]
fn replay_all_hungarian_cosine_crashes() {
    ...
    for crash_file in &crash_files {
        ...
        let outcome = run_hungarian_cosine_case(&bytes);
        assert_eq!(
            outcome,
