...
use mass_spectrometry::fuzzing::{
    MsEntropyCleanSpectrumHarnessOutcome, run_ms_entropy_clean_spectrum_case,
};

const ARTIFACTS_DIR: &str = "fuzz/artifacts/ms_entropy_clean_spectrum";
const FIXTURE_CRASH_DIR: &str = "tests/fixtures/fuzz/ms_entropy_clean_spectrum/crashes";

#[test]
fn replay_all_ms_entropy_clean_spectrum_crashes() {
    ...
    for crash_file in &crash_files {
        ...
        let outcome = run_ms_entropy_clean_spectrum_case(&bytes);
        assert_eq!(
            outcome,
