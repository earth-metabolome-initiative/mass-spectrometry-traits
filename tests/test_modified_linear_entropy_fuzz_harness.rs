...
use mass_spectrometry::fuzzing::{
    ModifiedLinearEntropyHarnessOutcome, run_modified_linear_entropy_case,
};

const ARTIFACTS_DIR: &str = "fuzz/artifacts/modified_linear_entropy";
const FIXTURE_CRASH_DIR: &str = "tests/fixtures/fuzz/modified_linear_entropy/crashes";

#[test]
fn replay_all_modified_linear_entropy_crashes() {
    ...
    for crash_file in &crash_files {
        ...
        let outcome = run_modified_linear_entropy_case(&bytes);
        assert_eq!(
            outcome,
