...
use mass_spectrometry::fuzzing::{FlashEntropyHarnessOutcome, run_flash_entropy_case};

const ARTIFACTS_DIR: &str = "fuzz/artifacts/flash_entropy";
const FIXTURE_CRASH_DIR: &str = "tests/fixtures/fuzz/flash_entropy/crashes";

#[test]
fn replay_all_flash_entropy_crashes() {
    ...
    for crash_file in &crash_files {
        ...
        let outcome = run_flash_entropy_case(&bytes);
        assert_eq!(
            outcome,
