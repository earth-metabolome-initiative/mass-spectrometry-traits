//! Submodule providing data for n4 cholesten 3 one.
...
pub const N4_CHOLESTEN_3_ONE_PRECURSOR_MZ: f32 = 385.347;

/// The mass over charge values for n4 cholesten 3 one.
pub const N4_CHOLESTEN_3_ONE_MZ: [f32; 50] = [
...
/// The intensities for n4 cholesten 3 one.
pub const N4_CHOLESTEN_3_ONE_INTENSITIES: [f32; 50] = [
    11004014.0,
    10135773.0,
    12771678.0,
    29456328.0,
